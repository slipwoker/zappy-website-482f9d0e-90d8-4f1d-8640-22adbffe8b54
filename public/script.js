document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const inputs = contactForm.querySelectorAll('input[name], textarea[name], select[name]');
            ...
            if (!hasErrors) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(function() {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; border: 1px solid #28a745; border-radius: 4px; background: #d4edda;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '482f9d0e-90d8-4f1d-8640-22adbffe8b54',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '482f9d0e-90d8-4f1d-8640-22adbffe8b54';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '482f9d0e-90d8-4f1d-8640-22adbffe8b54';
